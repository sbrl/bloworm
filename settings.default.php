<?php
// The root in which bloworm is installed.
// used when giving people the bookmarklet code, since we need to know the
// full url because people will be using the bookmarklet on sites other than
// the one that ones bloworm is installed on

// Don't forget the trailing slash.

$root_url = "https://example.com/bloworm/";
